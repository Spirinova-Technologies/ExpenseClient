...
class UserPreferences {
    ...
    clearPreferences(){
        ...
        AsyncStorage.removeItem(this.homeTab)
        AsyncStorage.removeItem(this.supplierTab)
        AsyncStorage.removeItem(this.billsTab)
        AsyncStorage.removeItem(this.passbookTab)
    }
