...
const AppTabNavigation = createMaterialTopTabNavigator(
    ...
    defaultNavigationOptions: ({ navigation }) => ({
        tabBarIcon: ({ focused, horizontal, tintColor }) => {
            ...
            return <Icon type={type} name={iconName} style={{ color: tintColor }} />;
        },
    })
});
...
const AppStackNavigation = createStackNavigator({
    ...
    SupplierPayment:{
        screen:AddSupplierPaymentScreen
    },
    AddBill: {
...
const AuthStack = createStackNavigator({ SignIn: LoginScreen, SignUp: SignupScreen,ForgotPassword:ForgotPassword }, { initialRouteName: 'SignIn' });
